...
code-conductor work --title "Frontend Task" --manager "Frontend" --priority "medium"
...
code-conductor work --title "Backend Task" --manager "Backend" --priority "high"
...
code-conductor work --title "Documentation Task" --manager "Documentation" --priority "low"
...
code-conductor work --title "Default Manager Test" --priority "medium"
